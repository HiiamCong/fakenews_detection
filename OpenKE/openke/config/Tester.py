...
class Tester(object):
    ...
    def run_triple_classification(self, threshlod = None):
        ...
        # print("threshlod: {}".format(threshlod))
        res = np.concatenate([ans.reshape(-1,1), score.reshape(-1,1)], axis = -1)
        ...
        total_all = (float)(len(score))
        # print("total_all: {}".format(total_all))
        total_current = 0.0
        # print("total_current: {}".format(total_current))
        total_true = np.sum(ans)
        # print("total_true: {}".format(total_true))
        total_false = total_all - total_true
        # print("total_false: {}".format(total_false))
    ...
    def triple_classification(self, h, t, r, threshlod):
